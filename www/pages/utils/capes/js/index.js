...
async function buttonClick(){
    ...
    var url = `/api/cape/render?name=${name}`
    ...
    if(json.error) {
        ...
        document.getElementById("cape").src = json.render.web //image.setAttribute("ondblclick", `window.open("${image.src}", '_blank').focus()`)
        document.getElementById("cape").setAttribute('ondblclick', `window.open("${json.render.web}", '_blank').focus()`)
    }
}
